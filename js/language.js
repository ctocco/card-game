    ...
    if (page == 'index') {
        ...
        switch (language) {
            ...
            case "DE":
                ...
                lText2.innerText = lorem2;
                lText3.innerText = "Hallo, mein Name ist Claudio und ich bin ein Frontend-Entwickler mit einer Spezialisierung auf Javascript. Ich habe einen Hintergrund im Marketing. Im Rahmen meines Studiums habe ich während eines Schüleraustauschs am Politecnico di Milano in Kommunikationsdesign ein Verständnis für Design entwickelt. Ich bin auch ein begeisterter Musiker und möchte in Zukunft mein Interesse an Musik mit dem Programmieren verbinden.";
