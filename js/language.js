    ...
    if (page == 'index') {
        ...
        switch (language) {
            case "EN":
                ...
                lText2.innerText = "Hey, my name is Julian. After having taught German for more than five years, I decided to take on web development. In this project I've been working mainly on the game's logic. If you encounter any bugs, please tweet them at me including the hashtag #thanksjulian";
            ...
            case "DE":
                ...
                lText2.innerText = "Hey, ich bin der Julian und habe die letzten Jahre damit verbracht, Deutsch zu unterrichten. Jetzt habe ich mich dazu entschlossen, einen Kurs in Web Development zu belegen. In diesem Projekt war ich hauptsächlich für die Spielmechanik verantwortlich. Wenn ihr also auf Bugs stoßt oder das Spiel abstürzt, schreibt mir einen Tweet mit dem Hashtag #thanksjulian";
